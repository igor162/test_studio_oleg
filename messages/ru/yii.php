...
return [
    ...
    'Are you sure you want to restore this item?' => 'Вы уверенны, что хотите восстановить этот элемент?',
    'Delete' => 'Удалить',
    'Error' => 'Ошибка',
    ...
    'Method Not Allowed. This url can only handle the following request methods: {params}.' => 'Метод не разрешен. Этот URL-адрес может обрабатывать только следующие методы запроса: {params}.',
    'No' => 'Нет',
    ...
    '{delta, plural, =1{1 day} other{# days}}' => '{delta, plural, =1{день} one{# день} few{# дня} many{# дней} other{# дней}}',
