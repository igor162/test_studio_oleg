    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            [
                ...
                'url' => '#',
                'active' => $checkController(['staff', 'departments']),
                'items' => [
                    ['label' => \Yii::t('app', 'Employees'), 'icon' => 'fa fa-universal-access', 'url' => ['/staff/index'], ],
                    ['label' => \Yii::t('app', 'Departments'), 'icon' => 'fa fa-lock', 'url' => ['/departments/index'], ],
                ],
            ],
